...
apt update
${inst} virtualbox-6.1 
wget https://github.com/arsenetar/dupeguru/releases/download/4.1.1/dupeguru_4.1.1_amd64.deb
...
#mv ~/.ssh ~/.ssh.old
#ln -s ~/Insync/admin@betark.ru/OneDrive/.ssh ~/.ssh 

${inst} gnome-shell-extension-system-monitor indicator-multiload

wget -O - https://dl.winehq.org/wine-builds/winehq.key | apt-key add -
apt-add-repository "deb https://dl.winehq.org/wine-builds/ubuntu/ $(lsb_release -sc) main"
...
${inst} adcli aisleriot baobab branding-ubuntu cheese deja-dup gnome-calendar gnome-mahjongg gnome-mines gnome-sudoku \
  gnome-todo libreoffice-calc libreoffice-gnome libreoffice-impress libreoffice-math libreoffice-ogltrans \
